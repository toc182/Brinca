...
> - Navigation model and data persistence live in [`docs/ux/`](ux/).
> - Visual design tokens, components, mascot visuals live in [`docs/design-system/`](design-system/).
> - Voice, microcopy, and brand identity live in [`docs/brand/`](brand/).
>
