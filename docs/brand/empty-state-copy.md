...
Per-context Capi expression and bilingual copy for empty states. Visual layout spec lives in `docs/design-system/components/empty-state.md`.

> Adult clinical / data screens use a Phosphor duotone icon at 48pt instead of Capi (see component spec).

---

| Context | Capi expression | English | Spanish |
|---|---|---|---|
...
| No progress yet | Neutral / Thinking | Progress shows up after 2–3 sessions. | El progreso aparece después de 2–3 sesiones. |
| No rewards yet | Encouraging | Keep going — rewards are on the way! | Sigue así — ¡las recompensas están cerca! |
