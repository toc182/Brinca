> ⚠️ **DEPRECATED — content has moved.**
> - Visual specs (tokens, components, mascot) live in [`docs/design-system/`](design-system/).
> - Brand identity, voice, and microcopy live in [`docs/brand/`](brand/).
>
> **Do not edit this file.** Update the new files instead. This file will be deleted once remaining references are cleaned up — tracked in [issue #6](https://github.com/toc182/Brinca/issues/6).
